...
public class Bat : Monster
{
	...
	public override List<Item> getExtraDropItems()
	{
		...
		if ((bool)this.cursedDoll && Game1.random.NextDouble() < 0.1429 && (bool)this.hauntedSkull)
		{
		...
		if ((bool)this.hauntedSkull && Game1.random.NextDouble() < 0.25 && Game1.IsWinter)
		{
			do
			{
		...
		if ((bool)this.hauntedSkull && Game1.random.NextDouble() < 0.01)
		{
			extraDrops.Add(ItemRegistry.Create("(M)CursedMannequin" + ((Game1.random.NextDouble() < 0.5) ? "Male" : "Female")));
		}
		if ((bool)this.hauntedSkull && Game1.random.NextDouble() < 0.001502)
		{
		...
		else
		{
			...
			if (base.Health <= 0)
			{
				...
				if ((bool)this.cursedDoll)
				{
					...
					if ((bool)this.hauntedSkull)
					{
						Game1.multiplayer.broadcastSprites(who.currentLocation, new TemporaryAnimatedSprite(this.Sprite.textureName, new Rectangle(0, 32, 16, 16), 2000f, 1, 9999, pixelPosition, flicker: false, flipped: false, 1f, 0.02f, Color.White, 4f, 0f, 0f, 0f)
						{
					...
					else if (who != null && !this.magmaSprite)
					{
	...
	public override void shedChunks(int number, float scale)
	{
		...
		if ((bool)this.cursedDoll && (bool)this.hauntedSkull)
		{
			Game1.createRadialDebris(base.currentLocation, this.Sprite.textureName, new Rectangle(0, 64, 16, 16), 8, standingPixel.X, standingPixel.Y, number, base.TilePoint.Y, Color.White, 4f);
		}
		else
		{
			Game1.createRadialDebris(base.currentLocation, this.Sprite.textureName, new Rectangle(0, 384, 64, 64), 32, standingPixel.X, standingPixel.Y, number, base.TilePoint.Y, Color.White, scale);
		}
	}
	...
	public override void drawAboveAllLayers(SpriteBatch b)
	{
		...
		if ((bool)this.cursedDoll)
		{
			if ((bool)this.hauntedSkull)
			{
				...
				b.Draw(this.Sprite.Texture, base.getLocalPosition(Game1.viewport) + new Vector2(32 + Game1.random.Next(-6, 7), 32 + Game1.random.Next(-6, 7)) + offset3, Game1.getSourceRectForStandardTileSheet(this.Sprite.Texture, direction2 * 2 + (((bool)this.seenPlayer && Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 500.0 < 250.0) ? 1 : 0), 16, 16), Color.Red * 0.44f, 0f, new Vector2(8f, 16f), Math.Max(0.2f, base.scale.Value) * 4f, base.flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (base.position.Y + 128f - 1f) / 10000f);
				b.Draw(this.Sprite.Texture, base.getLocalPosition(Game1.viewport) + new Vector2(32 + Game1.random.Next(-6, 7), 32 + Game1.random.Next(-6, 7)) + offset3, Game1.getSourceRectForStandardTileSheet(this.Sprite.Texture, direction2 * 2 + (((bool)this.seenPlayer && Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 500.0 < 250.0) ? 1 : 0), 16, 16), Color.Yellow * 0.44f, 0f, new Vector2(8f, 16f), Math.Max(0.2f, base.scale.Value) * 4f, base.flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (base.position.Y + 128f) / 10000f);
				if ((bool)this.seenPlayer)
				{
					for (int i = this.previousPositions.Count - 1; i >= 0; i -= 2)
					{
						b.Draw(this.Sprite.Texture, new Vector2(this.previousPositions[i].X - (float)Game1.viewport.X, this.previousPositions[i].Y - (float)Game1.viewport.Y + (float)base.yJumpOffset) + base.drawOffset + new Vector2(32f, 32f) + offset3, Game1.getSourceRectForStandardTileSheet(this.Sprite.Texture, direction2 * 2 + (((bool)this.seenPlayer && Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 500.0 < 250.0) ? 1 : 0), 16, 16), Color.White * (0f + 0.125f * (float)i), 0f, new Vector2(8f, 16f), Math.Max(0.2f, base.scale.Value) * 4f, base.flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (base.position.Y + 128f - (float)i) / 10000f);
					}
				}
				b.Draw(this.Sprite.Texture, base.getLocalPosition(Game1.viewport) + new Vector2(32f, 32f) + offset3, Game1.getSourceRectForStandardTileSheet(this.Sprite.Texture, direction2 * 2 + (((bool)this.seenPlayer && Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 500.0 < 250.0) ? 1 : 0), 16, 16), Color.White, 0f, new Vector2(8f, 16f), Math.Max(0.2f, base.scale.Value) * 4f, base.flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (base.position.Y + 128f + 1f) / 10000f);
			}
			else if ((bool)this.magmaSprite)
			{
				...
				b.Draw(this.Sprite.Texture, base.getLocalPosition(Game1.viewport) + new Vector2(32 + Game1.random.Next(-6, 7), 32 + Game1.random.Next(-6, 7)) + offset2, Game1.getSourceRectForStandardTileSheet(this.Sprite.Texture, direction * 7 + (int)(Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 490.0 / 70.0), 16, 16), Color.Red * 0.44f, 0f, new Vector2(8f, 16f), Math.Max(0.2f, base.scale.Value) * 4f, base.flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0.9955f);
				b.Draw(this.Sprite.Texture, base.getLocalPosition(Game1.viewport) + new Vector2(32 + Game1.random.Next(-6, 7), 32 + Game1.random.Next(-6, 7)) + offset2, Game1.getSourceRectForStandardTileSheet(this.Sprite.Texture, direction * 7 + (int)(Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 490.0 / 70.0), 16, 16), Color.Yellow * 0.44f, 0f, new Vector2(8f, 16f), Math.Max(0.2f, base.scale.Value) * 4f, base.flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0.9975f);
				for (int j = this.previousPositions.Count - 1; j >= 0; j -= 2)
				{
					b.Draw(this.Sprite.Texture, new Vector2(this.previousPositions[j].X - (float)Game1.viewport.X, this.previousPositions[j].Y - (float)Game1.viewport.Y + (float)base.yJumpOffset) + base.drawOffset + new Vector2(32f, 32f) + offset2, Game1.getSourceRectForStandardTileSheet(this.Sprite.Texture, direction * 7 + (int)(Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 490.0 / 70.0), 16, 16), Color.White * (0f + 0.125f * (float)j), 0f, new Vector2(8f, 16f), Math.Max(0.2f, base.scale.Value) * 4f, base.flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 0.9985f);
				}
				b.Draw(this.Sprite.Texture, base.getLocalPosition(Game1.viewport) + new Vector2(32f, 32f) + offset2, Game1.getSourceRectForStandardTileSheet(this.Sprite.Texture, direction * 7 + (int)(Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 490.0 / 70.0), 16, 16), Color.White, 0f, new Vector2(8f, 16f), Math.Max(0.2f, base.scale.Value) * 4f, base.flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, 1f);
			}
			else
			{
				int index = 103;
				...
				b.Draw(Game1.objectSpriteSheet, base.getLocalPosition(Game1.viewport) + new Vector2(32 + Game1.random.Next(-6, 7), 32 + Game1.random.Next(-6, 7)) + offset, Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, index, 16, 16), Color.Violet * 0.44f, 0f, new Vector2(8f, 16f), Math.Max(0.2f, base.scale.Value) * 4f, base.flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (base.position.Y + 128f - 1f) / 10000f);
				b.Draw(Game1.objectSpriteSheet, base.getLocalPosition(Game1.viewport) + new Vector2(32 + Game1.random.Next(-6, 7), 32 + Game1.random.Next(-6, 7)) + offset, Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, index, 16, 16), Color.Lime * 0.44f, 0f, new Vector2(8f, 16f), Math.Max(0.2f, base.scale.Value) * 4f, base.flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (base.position.Y + 128f) / 10000f);
				b.Draw(Game1.objectSpriteSheet, base.getLocalPosition(Game1.viewport) + new Vector2(32f, 32f) + offset, Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, index, 16, 16), (index == 789) ? Color.White : new Color(255, 50, 50), 0f, new Vector2(8f, 16f), Math.Max(0.2f, base.scale.Value) * 4f, base.flip ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (base.position.Y + 128f + 1f) / 10000f);
			}
		}
		else
		{
	...
	public override void behaviorAtGameTick(GameTime time)
	{
		...
		if ((bool)this.magmaSprite && !this.seenPlayer)
		{
			base.currentLocation.playSound("magma_sprite_spot");
		}
		this.seenPlayer.Value = true;
	...
	{
		if (base.focusedOnFarmers || this.withinPlayerThreshold(6) || (bool)this.seenPlayer || this.magmaSprite.Value)
		{
			this.Sprite.Animate(time, 0, 4, 80f);
			if (this.Sprite.currentFrame % 3 == 0 && Utility.isOnScreen(base.Position, 512) && (this.batFlap == null || !this.batFlap.IsPlaying) && base.currentLocation == Game1.currentLocation && !this.cursedDoll)
			{
