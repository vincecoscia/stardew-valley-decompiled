...
public class DesktopClipboard
{
	...
	public static bool GetText(ref string output)
	{
		...
		if (DesktopClipboard.externalGetText("xclip", "-o", ref output) || DesktopClipboard.externalGetText("pbpaste", "", ref output))
		{
			return true;
		}
		return false;
	...
	public static bool SetText(string text)
	{
		...
		if (!DesktopClipboard.externalSetText("xclip", "-selection clipboard", text))
		{
			return DesktopClipboard.externalSetText("pbcopy", "", text);
		}
		return true;
	}
