...
public class FarmerTeam : INetObject<NetFields>
{
	...
	/// <summary>All mail that has been broadcast globally. This can be used in the future to grant new farmhands/disconnected players any globally broadcast mail they may have missed out on.</summary>
	...
	private void OnCalicoEggRatingChanged(NetInt field, int oldValue, int newValue)
	{
		...
		if (newValue > DesertFestival.highestCalicoEggRatingToday)
		{
			DesertFestival.highestCalicoEggRatingToday = newValue;
		}
	}
	...
	{
		if ((bool)this.useSeparateWallets)
		{
	...
	{
		if (this.specialOrders.Any((SpecialOrder p) => p.questKey == id))
		{
			return;
		}
