...
public class BasicProjectile : Projectile
{
	...
	public override void behaviorOnCollisionWithPlayer(GameLocation location, Farmer player)
	{
		...
		player.takeDamage(this.damageToFarmer, overrideParry: false, null);
	...
	{
		if (!base.ignoreObjectCollisions)
		{
			this.explosionAnimation(location);
			base.piercesLeft.Value--;
		}
	...
	public override void behaviorOnCollisionWithMonster(NPC n, GameLocation location)
	{
		...
		if (n is Monster)
		{
			location.damageMonster(n.GetBoundingBox(), this.damageToFarmer, (int)this.damageToFarmer + 1, isBomb: false, player, isProjectile: true);
			if ((int)base.currentTileSheetIndex == 15)
			{
	...
	protected virtual void explosionAnimation(GameLocation location)
	{
		...
		{
			location.playSound(this.collisionSound);
		}
		if ((bool)this.explode)
		{
