...
public class Child : NPC
{
	...
	public override void reloadSprite(bool onlyAppearance = false)
	{
		...
		{
			Farmer parent = Game1.getFarmerMaybeOffline(this.idOfParent.Value);
	...
	public override void dayUpdate(int dayOfMonth)
	{
		...
		if ((int)base.age == 0 || (int)base.age == 1)
		{
		...
		if (base.Age == 3)
		{
			...
			{
				p = (base.currentLocation as FarmHouse).GetChildBedSpot(this.GetChildIndex());
				if (!p.Equals(Point.Zero))
				{
					base.setTilePosition(p);
				}
	...
	public void toddlerReachedDestination(Character c, GameLocation l)
	{
		if (Game1.random.NextDouble() < 0.8 && c.FacingDirection == 2)
		{
			...
			animation.Add(new FarmerSprite.AnimationFrame(16, 120, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(17, 120, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(18, 120, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(19, 120, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(18, 120, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(17, 120, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(16, 120, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(0, 1000, 0, secondaryArm: false, flip: false));
			...
			animation.Add(new FarmerSprite.AnimationFrame(18, 300, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(17, 100, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(16, 100, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(0, 2000, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(16, 120, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(17, 180, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(16, 120, 0, secondaryArm: false, flip: false));
			animation.Add(new FarmerSprite.AnimationFrame(0, 800, 0, secondaryArm: false, flip: false));
		...
		else if (Game1.random.NextDouble() < 0.8 && c.FacingDirection == 3)
		{
			...
			animation3.Add(new FarmerSprite.AnimationFrame(20, 120, 0, secondaryArm: false, flip: true));
			animation3.Add(new FarmerSprite.AnimationFrame(21, 70, 0, secondaryArm: false, flip: true));
			animation3.Add(new FarmerSprite.AnimationFrame(22, 70, 0, secondaryArm: false, flip: true));
			animation3.Add(new FarmerSprite.AnimationFrame(23, 70, 0, secondaryArm: false, flip: true));
			animation3.Add(new FarmerSprite.AnimationFrame(22, 999999, 0, secondaryArm: false, flip: true));
