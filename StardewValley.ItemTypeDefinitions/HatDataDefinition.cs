...
public class HatDataDefinition : BaseItemDataDefinition
{
	...
	public override ParsedItemData GetData(string itemId)
	{
		...
		return new ParsedItemData(this, itemId, this.GetSpriteIndex(itemId, fields), ArgUtility.Get(fields, 7) ?? "Characters\\Farmer\\hats", ArgUtility.Get(fields, 0), ArgUtility.Get(fields, 5), ArgUtility.Get(fields, 1), -95, null, fields);
	}
