...
public class FurnitureDataDefinition : BaseItemDataDefinition
{
	...
	public override ParsedItemData GetData(string itemId)
	{
		...
		return new ParsedItemData(this, itemId, this.GetSpriteIndex(itemId, fields), ArgUtility.Get(fields, 9, "TileSheets\\furniture", allowBlank: false), ArgUtility.Get(fields, 0), TokenParser.ParseText(ArgUtility.Get(fields, 7)), null, -24, null, fields, isErrorItem: false, ArgUtility.GetBool(fields, 10));
	}
	...
	{
		if (itemId == null || !this.GetDataSheet().TryGetValue(itemId, out var raw))
		{
			return null;
		}
		return raw.Split('/');
