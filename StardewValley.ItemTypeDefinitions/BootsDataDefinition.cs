...
public class BootsDataDefinition : BaseItemDataDefinition
{
	...
	public override ParsedItemData GetData(string itemId)
	{
		...
		return new ParsedItemData(this, itemId, this.GetSpriteIndex(itemId, fields), ArgUtility.Get(fields, 9) ?? "Maps\\springobjects", ArgUtility.Get(fields, 0), ArgUtility.Get(fields, 6), ArgUtility.Get(fields, 1), -97, null, fields);
	}
