...
public class Pan : Tool
{
	...
	public override void DoFunction(GameLocation location, int x, int y, int power, Farmer who)
	{
		...
		for (int i = 0; i < (int)base.upgradeLevel - 1; i++)
		{
	...
	public List<Item> getPanItems(GameLocation location, Farmer who)
	{
		...
		roll -= (double)((int)base.upgradeLevel - 1) * 0.05;
		if (roll < 0.01)
		{
			whichOre = "386";
		}
		...
		orePieces += (int)base.upgradeLevel - 1;
		roll = r.NextDouble() - who.DailyLuck;
		int numRolls = base.upgradeLevel;
		bool gotRing = false;
		double extraChance = (double)((int)base.upgradeLevel - 1) * 0.04;
		...
		{
			roll = r.NextDouble() - who.DailyLuck;
			roll -= (double)((int)base.upgradeLevel - 1) * 0.005;
			whichExtra = "382";
