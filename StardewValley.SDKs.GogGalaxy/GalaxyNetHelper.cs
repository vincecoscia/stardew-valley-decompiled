...
public class GalaxyNetHelper : SDKNetHelper
{
	...
	public GalaxyNetHelper()
	{
		...
		this.lobbyJoinRequested = new GalaxyGameJoinRequestedListener(onLobbyJoinRequested);
		this.lobbyEntered = new GalaxyLobbyEnteredListener(onLobbyEntered);
		this.lobbyDataListener = new GalaxyLobbyDataListener(onLobbyDataUpdated);
		this.richPresenceListener = new GalaxyRichPresenceListener(onRichPresenceUpdated);
