...
public class BaseEnchantment : INetObject<NetFields>
{
	...
	public static List<BaseEnchantment> GetAvailableEnchantments()
	{
		if (BaseEnchantment._enchantments == null)
		{
			...
			BaseEnchantment._enchantments.Add(new ArtfulEnchantment());
			BaseEnchantment._enchantments.Add(new BugKillerEnchantment());
			BaseEnchantment._enchantments.Add(new VampiricEnchantment());
			BaseEnchantment._enchantments.Add(new CrusaderEnchantment());
			BaseEnchantment._enchantments.Add(new HaymakerEnchantment());
			BaseEnchantment._enchantments.Add(new PowerfulEnchantment());
			BaseEnchantment._enchantments.Add(new ReachingToolEnchantment());
			BaseEnchantment._enchantments.Add(new ShavingEnchantment());
			BaseEnchantment._enchantments.Add(new BottomlessEnchantment());
			BaseEnchantment._enchantments.Add(new GenerousEnchantment());
			BaseEnchantment._enchantments.Add(new ArchaeologistEnchantment());
			BaseEnchantment._enchantments.Add(new MasterEnchantment());
			BaseEnchantment._enchantments.Add(new AutoHookEnchantment());
			BaseEnchantment._enchantments.Add(new PreservingEnchantment());
			BaseEnchantment._enchantments.Add(new EfficientToolEnchantment());
			BaseEnchantment._enchantments.Add(new SwiftToolEnchantment());
			BaseEnchantment._enchantments.Add(new FisherEnchantment());
		}
	...
	{
		this._OnMonsterSlay(m, location, who);
	}
