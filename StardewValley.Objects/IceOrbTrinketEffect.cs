...
public class IceOrbTrinketEffect : TrinketEffect
{
	...
	public override void GenerateRandomStats(Trinket trinket)
	{
		...
		this.projectileDelayMS = r.Next(3000, 5001);
		...
		if (r.NextDouble() < 0.05)
		{
			...
			this.projectileDelayMS = 3000f;
			this.freezeTime = 4000;
		}
		trinket.descriptionSubstitutionTemplates.Add(Math.Round(this.projectileDelayMS / 1000f, 1).ToString(CultureInfo.InvariantCulture));
