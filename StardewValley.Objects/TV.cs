...
public class TV : Furniture
{
	...
	public virtual void selectChannel(Farmer who, string answer)
	{
		...
		{
			Game1.currentLightSources.Add(new LightSource(2, this.getScreenPosition() + ((base.QualifiedItemId == "(F)1468") ? new Vector2(88f, 80f) : new Vector2(38f, 48f)), (base.QualifiedItemId == "(F)1468") ? 1f : 0.55f, Color.Black, 70907, LightSource.LightContext.None, 0L));
		}
	}
	...
	protected virtual void setWeatherOverlay(bool island = false)
	{
		...
		switch (island ? Game1.netWorldState.Value.GetWeatherForLocation("Island").WeatherForTomorrow : ((!Game1.IsMasterGame) ? Game1.getWeatherModificationsForDate(tomorrow, Game1.netWorldState.Value.WeatherForTomorrow) : Game1.getWeatherModificationsForDate(tomorrow, Game1.weatherForTomorrow)))
		{
		case "Wedding":
		case "Sun":
