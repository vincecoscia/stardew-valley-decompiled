...
public class MapArea
{
		...
		if (this.CachedTextures == null)
		{
			if (this.Data.Textures.Count > 0)
			{
				...
				foreach (WorldMapTextureData entry in this.Data.Textures)
				{
					...
					{
						texture = this.GetTexture("MOD_FARM");
	...
	{
		string textureName = assetName;
		if (assetName == "MOD_FARM")
		{
			textureName = ((Game1.whichModFarm?.WorldMapTexture != null) ? Game1.whichModFarm.WorldMapTexture : "LooseSprites\\Map");
		}
