...
internal sealed class SteamNetHelper : SDKNetHelper
{
	...
	public SteamNetHelper()
	{
		...
		this.GameLobbyJoinRequestedCallback = Callback<GameLobbyJoinRequested_t>.Create(OnGameLobbyJoinRequested);
		this.LobbyDataUpdateCallback = Callback<LobbyDataUpdate_t>.Create(OnLobbyDataUpdate);
