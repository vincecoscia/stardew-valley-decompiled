...
public class IslandWest : IslandLocation
{
	...
	public override bool checkAction(Location tileLocation, xTile.Dimensions.Rectangle viewport, Farmer who)
	{
		...
		if (base.getTileIndexAt(tileLocation.X, tileLocation.Y, "Buildings") != -1 && base.getTileIndexAt(tileLocation.X, tileLocation.Y, "Buildings") == 1470)
		{
	...
	public void ApplyFarmHouseRestore()
	{
		if (base.map != null)
		{
			...
			{
				base.setMapTileIndex(81, 40, 771, "Buildings");
				base.setMapTileIndex(81, 39, 739, "Front");
				base.setTileProperty(81, 40, "Buildings", "Action", "Mailbox");
			}
		}
	}
	...
	public override void TransferDataFromSavedLocation(GameLocation l)
	{
		...
		{
			this.farmhouseRestored.Value = location.farmhouseRestored;
			this.farmhouseMailbox.Value = location.farmhouseMailbox;
	...
	public override void spawnObjects()
	{
		...
		if (Utility.getNumObjectsOfIndexWithinRectangle(musselNodeSpawnArea, new string[1] { "(O)25" }, this) < 10)
		{
			...
			{
				base.objects.Add(spawn2, new Object("25", 1)
				{
					MinutesUntilReady = 8,
