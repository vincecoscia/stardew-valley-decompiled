...
public class ManorHouse : GameLocation
{
	...
	public override void MakeMapModifications(bool force = false)
	{
		...
		if (Game1.eventUp && Game1.CurrentEvent.id != "prizeTicketIntro")
		{
			...
			base.setMapTile(4, 6, 635, "Back", null);
		}
		else
		{
			base.setMapTile(4, 5, 109, "Buildings", "LostAndFound", 2);
			base.setMapTile(4, 4, 77, "Front", null, 2);
			base.setMapTile(4, 3, 110, "Front", null, 2);
			base.setMapTile(4, 6, 604, "Back", null);
		}
	}
