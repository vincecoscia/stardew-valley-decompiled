...
public class Submarine : GameLocation
{
	...
	{
		if (base.getTileIndexAt(tileLocation, "Buildings") == 217)
		{
	...
	public override void UpdateWhenCurrentLocation(GameTime time)
	{
		...
		else if (this.submerged.Value && !this.doneUntilReset)
		{
			...
			{
				Vector2 pos5 = new Vector2(Game1.random.Next(384, base.map.DisplayWidth - 64), 320f);
				int which3 = Game1.random.Next(3);
				Game1.background.tempSprites.Add(new TemporaryAnimatedSprite
				{
					motion = new Vector2(0f, -1f + (float)which3 * 0.2f),
					yStopCoordinate = 1,
					texture = this.submarineSprites,
			...
			{
				Vector2 pos4 = new Vector2(1344f, Game1.random.Next(448, 704));
				Game1.background.tempSprites.Add(new TemporaryAnimatedSprite
				{
			...
			{
				Vector2 pos3 = new Vector2(3f, 10f) * 64f;
				Game1.background.tempSprites.Add(new TemporaryAnimatedSprite
				{
					motion = new Vector2(-0f, -1f),
			...
			{
				Vector2 pos2 = new Vector2(24f, 2f) * 64f;
				...
				Game1.background.tempSprites.Add(new TemporaryAnimatedSprite
				{
					...
					xStopCoordinate = 64,
					texture = this.submarineSprites,
					sourceRectStartingPos = new Vector2(257 + which2 * 48, 81f),
					sourceRect = new Microsoft.Xna.Framework.Rectangle(257 + which2 * 48, 81, 16, 16),
