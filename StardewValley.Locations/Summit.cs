...
public class Summit : GameLocation
{
		...
		if (base.currentEvent == null && Game1.background != null && !Game1.background.cursed && base.temporarySprites.Count == 0 && Game1.random.NextDouble() < ((Game1.timeOfDay < 1800) ? 0.0006 : ((Game1.season == Season.Summer && Game1.dayOfMonth == 20) ? 1.0 : 0.001)))
		{
			...
			if (Game1.timeOfDay < 1800)
			{
				...
				case Season.Fall:
				{
					...
					{
						TemporaryAnimatedSprite bird5 = new TemporaryAnimatedSprite("LooseSprites\\Cursors", sourceRect, Game1.random.Next(80, 121), 4, 200, startingPosition + new Vector2((j + 1) * Game1.random.Next(15, 18), (j + 1) * -20), flicker: false, flipped: false, 0.01f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
						{
							layerDepth = 0f
						};
						bird5.motion = new Vector2(-1f, 0f);
						base.temporarySprites.Add(bird5);
						bird5 = new TemporaryAnimatedSprite("LooseSprites\\Cursors", sourceRect, Game1.random.Next(80, 121), 4, 200, startingPosition + new Vector2((j + 1) * Game1.random.Next(15, 18), (j + 1) * 20), flicker: false, flipped: false, 0.01f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
						{
							layerDepth = 0f
						};
						bird5.motion = new Vector2(-1f, 0f);
				...
				{
					TemporaryAnimatedSprite bird3 = localSeason switch
					{
				...
				else if (Game1.random.NextDouble() < 0.15 && Game1.stats.Get("childrenTurnedToDoves") > 1)
				{
					for (int i = 0; i < Game1.stats.Get("childrenTurnedToDoves"); i++)
					{
						...
						TemporaryAnimatedSprite bird4 = new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(388, 1894, 24, 21), Game1.random.Next(80, 121), 6, 200, startingPosition + new Vector2((i + 1) * (Game1.random.Next(25, 27) * 4), Game1.random.Next(-32, 33) * 4), flicker: false, flipped: false, 0.01f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
						{
							layerDepth = 0f
						};
				...
				{
					sourceRect = Rectangle.Empty;
					TemporaryAnimatedSprite bird2 = new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(222, 1890, 20, 9), 30f, 2, 99900, startingPosition, flicker: false, flipped: false, 0.01f, 0f, Color.White, 2f, 0f, 0f, 0f, local: true)
					{
						yPeriodic = true,
			...
			else if (Game1.timeOfDay >= 1900)
			{
				...
				if (localSeason == Season.Summer && Game1.dayOfMonth == 20)
				{
					...
					{
						TemporaryAnimatedSprite t2 = new TemporaryAnimatedSprite("LooseSprites\\Cursors", sourceRect, Game1.random.Next(80, 121), 4, loops, startingPosition, flicker: false, flipped: false, 0.01f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
						{
							layerDepth = 0f
						};
	...
	public string getEndSlideshow()
	{
		...
		foreach (KeyValuePair<string, string> v2 in dictionary)
		{
			try
			{
				string fishName = ItemRegistry.GetData("(O)" + v2.Key)?.DisplayName ?? ArgUtility.SplitBySpaceAndGet(v2.Value, 0);
		...
		foreach (KeyValuePair<string, string> v in DataLoader.Monsters(Game1.content))
		{
			...
			case "Shadow Guy":
			{
				spriteHeight = 32;
				spriteStartIndex = 4;
				Texture2D t4 = Game1.content.Load<Texture2D>("Characters\\Monsters\\Shadow Brute");
				base.TemporarySprites.Add(new TemporaryAnimatedSprite(null, new Rectangle(spriteWidth * spriteStartIndex % t4.Width, spriteWidth * spriteStartIndex / t4.Width * spriteHeight, spriteWidth, spriteHeight), 100f, animationLength, 999999, new Vector2(Game1.viewport.Width + 192, (float)Game1.viewport.Height * 0.5f - (float)(spriteHeight * 4) - 16f), flicker: false, flipped: true, 0.9f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
				{
					motion = new Vector2(-3f, 0f),
					delayBeforeAnimationStart = i,
				...
				t4 = Game1.content.Load<Texture2D>("Characters\\Monsters\\Shadow Shaman");
				spriteHeight = 24;
				...
				t4 = Game1.content.Load<Texture2D>("Characters\\Monsters\\Shadow Sniper");
				spriteHeight = 32;
				spriteWidth = 32;
				...
				base.TemporarySprites.Add(new TemporaryAnimatedSprite(null, new Rectangle(spriteWidth * spriteStartIndex % t4.Width, spriteWidth * spriteStartIndex / t4.Width * spriteHeight, spriteWidth, spriteHeight), 100f, animationLength, 999999, new Vector2((float)(Game1.viewport.Width + 128 + spriteWidth * 4 / 2) - Game1.dialogueFont.MeasureString(v.Value.Split('/')[14]).X / 2f, (float)Game1.viewport.Height * 0.5f), flicker: false, flipped: false, 0.9f, 0f, Color.White, 1f, 0f, 0f, 0f, local: true)
				{
					motion = new Vector2(-3f, 0f),
					delayBeforeAnimationStart = i,
			...
			case "Green Slime":
			{
				...
				{
					t2 = Game1.content.Load<Texture2D>("Characters\\Monsters\\Green Slime");
				}
				spriteHeight = 32;
				spriteStartIndex = 4;
				GreenSlime slime = new GreenSlime(Vector2.Zero, 0);
				base.TemporarySprites.Add(new TemporaryAnimatedSprite(null, new Rectangle(spriteWidth * spriteStartIndex % t2.Width, spriteWidth * spriteStartIndex / t2.Width * spriteHeight, spriteWidth, spriteHeight), 100f, animationLength, 999999, new Vector2(Game1.viewport.Width + 192 - 64, (float)Game1.viewport.Height * 0.5f - (float)(spriteHeight * 4) + 32f), flicker: false, flipped: true, 0.9f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
				{
					motion = new Vector2(-3f, 0f),
					delayBeforeAnimationStart = i,
					yPeriodic = (animationLength == 1),
				...
				base.TemporarySprites.Add(new TemporaryAnimatedSprite(null, new Rectangle(spriteWidth * spriteStartIndex % t2.Width, spriteWidth * spriteStartIndex / t2.Width * spriteHeight, spriteWidth, spriteHeight), 100f, animationLength, 999999, new Vector2((float)Game1.viewport.Width + 240f - 64f, (float)Game1.viewport.Height * 0.5f - (float)(spriteHeight * 4 * 2) + 32f), flicker: false, flipped: true, 0.9f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
				{
					motion = new Vector2(-3f, 0f),
					delayBeforeAnimationStart = i,
					yPeriodic = (animationLength == 1),
				...
				base.TemporarySprites.Add(new TemporaryAnimatedSprite(null, new Rectangle(spriteWidth * spriteStartIndex % t2.Width, spriteWidth * spriteStartIndex / t2.Width * spriteHeight, spriteWidth, spriteHeight), 100f, animationLength, 999999, new Vector2((float)Game1.viewport.Width + 144f - 64f, (float)Game1.viewport.Height * 0.5f - (float)(spriteHeight * 4 * 2) + 32f), flicker: false, flipped: true, 0.9f, 0f, Color.White, 4f, 0f, 0f, 0f, local: true)
				{
					motion = new Vector2(-3f, 0f),
					delayBeforeAnimationStart = i,
					yPeriodic = (animationLength == 1),
				...
				base.TemporarySprites.Add(new TemporaryAnimatedSprite(null, new Rectangle(spriteWidth * spriteStartIndex % t2.Width, spriteWidth * spriteStartIndex / t2.Width * spriteHeight, spriteWidth, spriteHeight), 100f, animationLength, 999999, new Vector2((float)(Game1.viewport.Width + 192 + spriteWidth * 4 / 2) - Game1.dialogueFont.MeasureString(v.Value.Split('/')[14]).X / 2f, (float)Game1.viewport.Height * 0.5f), flicker: false, flipped: false, 0.9f, 0f, Color.White, 1f, 0f, 0f, 0f, local: true)
				{
					motion = new Vector2(-3f, 0f),
					delayBeforeAnimationStart = i,
