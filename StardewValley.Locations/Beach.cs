...
public class Beach : GameLocation
{
	...
	{
		base.initNetFields();
		base.NetFields.AddField(this.bridgeFixed, "bridgeFixed");
	...
	public override void DayUpdate(int dayOfMonth)
	{
		...
		while (Game1.random.NextDouble() < (double)chance)
		{
			...
			Vector2 position3 = new Vector2(Game1.random.Next(tidePools.X, tidePools.Right), Game1.random.Next(tidePools.Y, tidePools.Bottom));
			if (this.CanItemBePlacedHere(position3))
			{
		...
		if (base.IsSummerHere() && Game1.dayOfMonth >= 12 && Game1.dayOfMonth <= 14)
		{
			...
			while (Game1.random.NextDouble() < (double)chance)
			{
				...
				Vector2 position = base.getRandomTile();
				position.Y /= 2f;
				string prop = this.doesTileHaveProperty((int)position.X, (int)position.Y, "Type", "Back");
				if (this.CanItemBePlacedHere(position) && (prop == null || !prop.Equals("Wood")))
				{
		...
		{
			if (base.characters[i].Name.Contains("derby_contestent"))
			{
	...
	public override void performTenMinuteUpdate(int timeOfDay)
	{
		...
		NPC i = base.getCharacterFromName("winter_derby_contestent" + r.Next(10));
		if (i == null)
		{
			return;
		}
		...
		if (r.NextBool(0.25))
		{
			...
			{
				base.temporarySprites.Add(new TemporaryAnimatedSprite(151, 1500f, 1, 1, i.Position, flicker: false, flipped: false, verticalFlipped: false, 0f)
				{
	...
	public override void MakeMapModifications(bool force = false)
	{
		...
		if (Game1.IsWinter && Game1.dayOfMonth >= 12 && Game1.dayOfMonth <= 13)
		{
			...
			else
			{
				if (base.getCharacterFromName("winter_derby_contestent0") != null)
				{
					base.getCharacterFromName("winter_derby_contestent0").drawOffset = new Vector2(0f, 96f);
					base.getCharacterFromName("winter_derby_contestent0").shouldShadowBeOffset = true;
				}
				if (base.getCharacterFromName("winter_derby_contestent1") != null)
				{
					base.getCharacterFromName("winter_derby_contestent1").Sprite.CurrentFrame = 2;
					base.getCharacterFromName("winter_derby_contestent1").drawOffset = new Vector2(0f, 96f);
					base.getCharacterFromName("winter_derby_contestent1").shouldShadowBeOffset = true;
				}
				if (base.getCharacterFromName("winter_derby_contestent2") != null)
				{
					base.getCharacterFromName("winter_derby_contestent2").Sprite.CurrentFrame = 3;
					base.getCharacterFromName("winter_derby_contestent2").drawOffset = new Vector2(0f, 96f);
					base.getCharacterFromName("winter_derby_contestent2").shouldShadowBeOffset = true;
				}
				if (base.getCharacterFromName("winter_derby_contestent3") != null)
				{
					base.getCharacterFromName("winter_derby_contestent3").Sprite.CurrentFrame = 1;
					base.getCharacterFromName("winter_derby_contestent3").drawOffset = new Vector2(0f, 96f);
					base.getCharacterFromName("winter_derby_contestent3").shouldShadowBeOffset = true;
				}
				if (base.getCharacterFromName("winter_derby_contestent4") != null)
				{
					base.getCharacterFromName("winter_derby_contestent4").Sprite.CurrentFrame = 2;
					base.getCharacterFromName("winter_derby_contestent4").drawOffset = new Vector2(0f, 96f);
					base.getCharacterFromName("winter_derby_contestent4").shouldShadowBeOffset = true;
				}
				if (base.getCharacterFromName("winter_derby_contestent5") != null)
				{
					base.getCharacterFromName("winter_derby_contestent5").Sprite.CurrentFrame = 8;
					base.getCharacterFromName("winter_derby_contestent5").shouldShadowBeOffset = true;
				}
				if (base.getCharacterFromName("winter_derby_contestent6") != null)
				{
					base.getCharacterFromName("winter_derby_contestent6").Sprite.CurrentFrame = 9;
					base.getCharacterFromName("winter_derby_contestent6").shouldShadowBeOffset = true;
				}
				if (base.getCharacterFromName("winter_derby_contestent7") != null)
				{
					base.getCharacterFromName("winter_derby_contestent7").Sprite.CurrentFrame = 10;
					base.getCharacterFromName("winter_derby_contestent7").shouldShadowBeOffset = true;
				}
				if (base.getCharacterFromName("winter_derby_contestent8") != null)
				{
					base.getCharacterFromName("winter_derby_contestent8").Sprite.CurrentFrame = 11;
					base.getCharacterFromName("winter_derby_contestent8").shouldShadowBeOffset = true;
				}
				if (base.getCharacterFromName("winter_derby_contestent9") != null)
				{
					base.getCharacterFromName("winter_derby_contestent9").Sprite.CurrentFrame = 12;
					base.getCharacterFromName("winter_derby_contestent9").shouldShadowBeOffset = true;
				}
				if (base.getCharacterFromName("winter_derby_contestent10") != null)
				{
					base.getCharacterFromName("winter_derby_contestent10").Sprite.CurrentFrame = 6;
					base.getCharacterFromName("winter_derby_contestent10").drawOffset = new Vector2(0f, 96f);
					base.getCharacterFromName("winter_derby_contestent10").shouldShadowBeOffset = true;
				}
				if (base.getCharacterFromName("winter_derby_contestent11") != null)
				{
					base.getCharacterFromName("winter_derby_contestent11").Sprite.CurrentFrame = 7;
					base.getCharacterFromName("winter_derby_contestent11").drawOffset = new Vector2(0f, 96f);
					base.getCharacterFromName("winter_derby_contestent11").shouldShadowBeOffset = true;
				}
			}
			...
			{
				base.setMapTileIndex(13, 6, 51, "Front");
				base.setMapTileIndex(13, 5, 43, "AlwaysFront");
			}
		...
		{
			if (!base._appliedMapOverrides.Contains("Beach_SquidFest") && base.getTileIndexAt(11, 7, "Buildings") != 45)
			{
				return;
			}
