...
public class Mountain : GameLocation
{
	...
	public void ApplyTreehouseIfNecessary()
	{
		...
		{
			TileSheet tilesheet = base.map.GetTileSheet("untitled tile sheet2");
	...
	private void restoreBridge()
	{
		...
		for (int x = 0; x < fixedBackLayer.LayerWidth; x++)
		{
			...
			{
				curBackLayer.Tiles[x + xOffset, y + yOffset] = ((fixedBackLayer.Tiles[x, y] == null) ? null : new StaticTile(curBackLayer, base.map.TileSheets[0], BlendMode.Alpha, fixedBackLayer.Tiles[x, y].TileIndex));
				curBuildingsLayer.Tiles[x + xOffset, y + yOffset] = ((fixedBuildingsLayer.Tiles[x, y] == null) ? null : new StaticTile(curBuildingsLayer, base.map.TileSheets[0], BlendMode.Alpha, fixedBuildingsLayer.Tiles[x, y].TileIndex));
				curFrontLayer.Tiles[x + xOffset, y + yOffset] = ((fixedFrontLayer.Tiles[x, y] == null) ? null : new StaticTile(curFrontLayer, base.map.TileSheets[0], BlendMode.Alpha, fixedFrontLayer.Tiles[x, y].TileIndex));
			}
		}
	...
	public override void UpdateWhenCurrentLocation(GameTime time)
	{
		...
		if ((bool)this.landslide && (int)((Game1.currentGameTime.TotalGameTime.TotalMilliseconds - 400.0) / 1600.0) % 2 != 0 && Utility.isOnScreen(new Point(this.landSlideRect.X / 64, this.landSlideRect.Y / 64), 128))
		{
	...
	{
		if ((bool)this.landslide && position.Intersects(this.landSlideRect))
		{
			return true;
		}
		if ((bool)this.railroadAreaBlocked && position.Intersects(this.railroadBlockRect))
		{
			return true;
		}
	...
	public override bool isTilePlaceable(Vector2 tileLocation, bool itemIsPassable = false)
	{
		...
		if ((bool)this.landslide && this.landSlideRect.Contains(non_tile_position))
		{
			return false;
		}
		if ((bool)this.railroadAreaBlocked && this.railroadBlockRect.Contains(non_tile_position))
		{
			return false;
		}
	...
	public override void draw(SpriteBatch spriteBatch)
	{
		...
		if ((bool)this.oreBoulderPresent)
		{
		...
		if ((bool)this.railroadAreaBlocked)
		{
