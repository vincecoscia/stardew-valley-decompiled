...
public static class TokenStringBuilder
{
	...
	{
		return TokenStringBuilder.BuildTokenWithArgumentString("ArticleFor", tokenizedString);
	}
	...
	public static string ItemName(string itemId, string fallbackText = null)
	{
		...
		return TokenStringBuilder.BuildTokenWithArgumentString("ItemName", itemId, fallbackText);
	}
