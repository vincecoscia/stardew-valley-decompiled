	...
	internal int Process(InflateBlocks blocks, int r)
	{
		...
		while (true)
		{
			...
			case 1:
			{
				...
				int tindex = (this.tree_index + (b & InternalInflateConstants.InflateMask[i])) * 3;
			...
			case 2:
			{
				...
				this.len += b & InternalInflateConstants.InflateMask[i];
				b >>= i;
				j -= i;
			...
			case 4:
			{
				...
				this.dist += b & InternalInflateConstants.InflateMask[i];
				b >>= i;
				j -= i;
				this.mode = 5;
				goto case 5;
